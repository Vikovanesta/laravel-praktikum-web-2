...
<div class="flex justify-center">
    <div class="container">
        <h1 class="text-center mt-4 mb-12 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Most Popular Book</h1>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-5 py-3 text-center">Rating</th>
                ...
                <tbody>
                    @foreach ($books as $book)
                        <tr>
                            ...
                            <td class="px-5 py-4">{{ number_format($book->ratings->avg('rating'), 2) }}</td>
                            <td class="px-5 py-4">
